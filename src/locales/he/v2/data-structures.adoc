...
[source,javascript]
----
// Iterating through Arrays: Using a list to hold several audio clips and placing them in our DAW thanks to a for loop
...
[source,javascript]
----
// String and Arrays Operations: Showing what we can do with lists and arrays
// Setup
setTempo(120);
