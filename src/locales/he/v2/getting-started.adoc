...
[source,python]
----
include::../../en/code-examples/getting-started-intro-script.py.txt[]
----

[role="curriculum-javascript"]
[source,javascript]
----
include::../../en/code-examples/getting-started-intro-script.js.txt[]
----
...
[source,python]
----
include::../../en/code-examples/getting-started-using-fitmedia.py.txt[]
----

[role="curriculum-javascript"]
[source,javascript]
----
include::../../en/code-examples/getting-started-using-fitmedia.js.txt[]
----
...
[source,python]
----
include::../../en/code-examples/getting-started-using-fitmedia-2.py.txt[]
----

[role="curriculum-javascript"]
[source,javascript]
----
include::../../en/code-examples/getting-started-using-fitmedia-2.js.txt[]
----
...
[source,python]
----
include::../../en/code-examples/getting-started-finding-errors.py.txt[]
----

[role="curriculum-javascript"]
[source,javascript]
----
include::../../en/code-examples/getting-started-finding-errors.js.txt[]
----
////
OPTIONAL
////
