...
.תרגלו
****
כתוב שיר בשני ערוצים ושנו את העוצמה (ווליום) של שני הערוצים בעזרת הפונקציה `()setEffect`. 
...
. הפכו ללא הערה את שורת `()setEffect` והקשיבו להבדל (להפוך שרה ללא הערה פירושו למחוק מתחילת השורה את `#` או`//` ).
...
.תרגלו
****
צרו שיר חדש. השתמשו בלולאת for כדי להוסיף מעטפת לכל הערוצים (למשל, fade in ו-fade out לכל הערוצים), או כדי לחזור כל אפקט באותו ערוץ. השתמשו באיזה אפקט שתרצו. 
