...
1. Now change the tempo by changing the number in parentheses after `setTempo()`.
You can increase the tempo to `150` or decrease it `90`.
1. Click run again and then the green play button. How did changing the tempo affect the mood of the music?
1. Here are some examples of average tempos of different music genres. Try different tempos with your current script.
* Hip Hop: 85-95 bpm
* Pop: 110-118 bpm
* Techno: 120-136 bpm
* Electro: 120-136 bpm
