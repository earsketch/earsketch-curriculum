...
1. If you already have an EarSketch account, login to your account.
1. In the box below, click the blue clipboard icon to copy this text into the code editor
1. When it pastes in the code editor, click import to edit
1. Click the green “Run” in the upper righthand corner of your code editor
1. Your script should run successfully and you should see different color blocks at the top of your screen.
1. Click the Play button to hear the remix.
****
...
1. Click play at the top of the EarSketch DAW to listen to your script.
1. Go to Line 23-28 in your script editor . Place a `#` in front of the some of the `fitMedia()` lines
1. Run your script again.
1. What happens? What is different about your song?
****
