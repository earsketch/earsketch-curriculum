...
La structure d'une musique est son organisation dans le temps : comment le.a musicien.ne crée des parties avec du sens, et des transitions pour un bon flow musical. C'est très courant en musique de danse électronique ou dance (EDM) et crée l'anticipation d'une perte de niveau sonore. Dans ce chapitre, vous créerez vos propres fonctions, appelées fonctions personnalisées, pour structurer vos musiques !
