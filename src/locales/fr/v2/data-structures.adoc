...
# code python
#
# script_name : Exemples de beats ou rythmes
#
# auteur : L'équipe EarSketch
#
# description : Création de beats avec des exemples de divers genres musicaux
#
#
...
// auteur : L'équipe EarSketch
//
// description : Création de beats (rythmes) avec divers exemples de genres musicaux
//
//
