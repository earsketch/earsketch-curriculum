...
.PRACTICE
****
Pour chacune des chaînes de percussion suivantes, essayez de taper des mains sur les zéros. Then listen to the corresponding audio and verify if you were right. Cet exercice vous aidera à comprendre comment fonctionnent les chaînes de percussion.
****
