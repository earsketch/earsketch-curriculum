...
#
# description : Utilisation de variables pour stocker des clips et simplifier les modifications
#
#
#
...
# auteur : L'équipe EarSketch
#
# description : Utilisation de plusieurs appels makeBeat et chevauchement de rythmes (beats)
#
#
#
...
# code python
#
# script_name : Exemples de beats
#
# auteur : L'équipe EarSketch
#
# description : Création de beats pour différents genres
#
#
