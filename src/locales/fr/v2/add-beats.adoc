...
. *Sound*: A sound constant. Vous pouvez utiliser le filtre GENRE dans la bibliothèque de sons et sélectionner « MAKEBEAT » : ce sont des clips audio courts adaptés pour les motifs rythmiques. These are short sounds appropriate for beat patterns.
