...
[source,python]
----
# Liaison de deux beats (rythmes) à l'aide d'instructions de retour
...
[source,python]
----
# Renvoi de la mesure de fin d'une fonction de partie
...
[source,python]
----
# Utilisation d'une booléenne pour créer une variation dans une fonction
