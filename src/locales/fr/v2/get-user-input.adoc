...
[source,python]
----
# Demande de saisie du tempo à l'utilisateur
...
[source,javascript]
----
// Demande de saisie de tempo à l'utilisateur
...
[source,python]
----
# Création d'une chanson de dubstep à l'aide de paramètres spécifiés par l'utilisateur
...
[source,javascript]
----
// Création d'une chanson de dubstep avec des paramètres spécifiés par l'utilisateur
...
[source,python]
----
# Affichage d'expressions booléennes
...
[source,python]
----
# Demande à l'utilisateur d'entrer un genre musical et création d'un beat en conséquence
