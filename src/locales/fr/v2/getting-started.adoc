...
. *Paramétrage du script :* EarSketch ajoute automatiquement des fonctions de paramétrage à un nouveau script, mais vous pourriez accidentellement supprimer `from earsketch import *`.
