...
* Vous avez également une ligne de basse. These are lower pitches. Il peut s'agir d'une basse, d'un violoncelle, des notes graves d'un clavier, etc.
...
* La *tonalité* d'une chanson indique la gamme ou le groupe de notes dans lequel la musique est composée. Keys are either major or minor, which tend to give a different impression to the listener.
