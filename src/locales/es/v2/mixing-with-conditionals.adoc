...
[source,python]
----
# Cómo usar la función analyseTrack() para desplegar (o imprimir) el volumen de una pista
...
[source,javascript]
----
// Cómo usar la función analyzeTrack() para desplegar (o imprimir) el volumen de una pista
...
[source,python]
----
# Analizamos el volumen de nuestras pistas
...
[source,python]
----
# Cómo crear una breve canción y usar declaraciones condicionales para mezclar las pistas
