...
Por ejemplo: `makeBeat(DUBSTEP_FILTERCHORD_002, 1, 1, "0--0--000--00-0")` colocará tu patrón `0--0--000--00-0-` en la pista 1 (track 1), en el compás 1, usando el clip de sonido `DUBSTEP_FILTERCHORD_02`.
