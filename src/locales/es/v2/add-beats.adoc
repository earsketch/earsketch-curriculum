...
[source,python]
----
# Cómo usar variables para almacenar clips y simplificar la edición
...
[source,python]
----
# Cómo usar varias llamadas a makeBeat y ritmos superpuestos
...
[source,python]
----
# Cómo crear ritmos en géneros diferentes
