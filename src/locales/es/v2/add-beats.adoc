...
Recuerda que una cadena es un tipo de dato Recuerda que una cadena es un tipo de dato Se consiste en una serie de caracteres (como `0` o `+`) dentro de comillas.
...
Usa variables para almacenar tus nombres de clips. Puedes ponerlos simultáneamente, en dos pistas musicales diferentes, o uno tras otro en una sola pista musical.
****
