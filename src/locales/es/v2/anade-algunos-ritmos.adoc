...
.PRÁCTICA
****
En tus previos scripts, usa variables para almacenar tus nombres de clips de sonido. Consulta los ejemplos a continuación si necesitas ayuda. Asegúrate de poner a tus variables nombres cortos y entendibles (como "bajo", "voz_1",...) que describan tu clip de sonido. Tus variables no pueden llevar tildes. Por ejemplo, si quisieras asignarle una variable al clip MILKNSIZZ_ADIOS_BRASS, podrías escribir "melodia1 = MILKNSIZZ_ADIOS_BRASS". Escribir "melodía1" con acento sería incorrecto.
****
...
# código python 
#
# nombre_del_script: Variables
#
# autor: El Equipo de EarSketch
#
# descripción: Cómo usar variables para almacenar clips y simplificar la edición
#
#
#
...
* 1 *tiempo* es la unidad de ritmo más básica.
* Un *compás* es una unidad de medida musical que agrupa una cantidad predeterminada de tiempos. En EarSketch, un *compás* dura 4 tiempos. Debido a que hay 4 tiempos en 1 compás, los tiempos también se llaman *negras (1/4 de nota)*.
* Cada *tiempo* se puede dividir en *subdivisiones*. Por ejemplo, una negra (1/4 de nota) se puede dividir en 2 *corcheas (1/8s de nota)*. Cuando cuentas negras (1/4s de nota), dices, "1, 2, 3, 4...". Cuando cuentas corcheas (1/8s de nota), usas "y": "1 y 2 y 3 y 4 y...". También se puede dividir una corchea (1/8 de nota) en 2 *semicorcheas (1/16s de nota)*.
...
Una cadena de golpes de tambor es una cadena que usa los caracteres "0", "+" o "-". Por ejemplo: "0-00-00-0+++0+0+". Típicamente tiene 16 caracteres, pero su tamaño puede variar. Cada carácter corresponde a una semicorchea (1/16 de nota). Entonces cadenas de golpes de tambor
con 16 caracteres duran un compás.
...
Recuerda que una cadena es un tipo de dato que se consiste en una serie de caracteres (como `0` o `+`) dentro de comillas.
...
Sixteenthnotes: `"0000000000000000"`
...
. *Cadena de tiempos*: Una cadena de ritmo compuesta de los caracteres `"0"`, `"+"`, y `"-"`.
...
# código python
#
# nombre_del_script: Múltiples ritmos
#
# autor: El Equipo de EarSketch
#
# descripción: Cómo usar varias llamadas a makeBeat y ritmos superpuestos
#
#
#
...
// código javascript
//
// nombre_del_script: Mútiples ritmos
//
// autor: El Equipo de EarSketch
//
// descripción: Cómo usar varias llamadas a makeBeat y ritmos superpuestos
...
Cuando escuches tu música, está perfectamente bien si no te gusta tu primera versión: modifica tu ritmo para que suene cada vez mejor, hasta que te guste lo que tengas.
****
...
# autor: El Equipo de EarSketch
#
# descripción: Cómo crear ritmos en géneros diferentes
#
...
** *numeroDeCompas:* El compás en que empieza el ritmo. La cadena de tiempos determina la duración total.
...
<script>
question6 = new Question(6, "questions:v2.addBeats.1.question", "questions:v2.addBeats.1.a1", "questions:v2.addBeats.1.a2", "questions:v2.addBeats.1.a3", "questions:v2.addBeats.1.a4");
question7 = new Question(7, "questions:v2.addBeats.2.question", "questions:v2.addBeats.2.a1", "questions:v2.addBeats.2.a2", "questions:v2.addBeats.2.a3", "questions:v2.addBeats.2.a4");
question1 = new Question(1, "¿Cuál de estas opciones es una cadena?", "Cinco", "5", "CINCO", "Cinco");
question2 = new Question(2, "¿Qué representa \"0\" en una cadena de patrón de tiempos?", "Empieza a tocar el clip", "Silencio", "Extiende el clip", "Para el clip");
question3 = new Question(3,"En EarSketch, un compás tiene...", "4 tiempos", "4 subdivisiones", "16 tiempos", "1 negra");
question4 = new Question(4, "Una semicorchea (1/16 de nota) es...", "un cuarto de una negra (1/4 de nota)", "la mitad de un tiempo", "un cuarto de compás", "1 compás");
question5 = new Question(5, "Para usar la función makeBeat(), cuáles son los parámetros que necesitas?", "el nombre del clip, la pista musical, el compás donde comienza el ritmo, la cadena de tiempos", "el tempo, la pista musical, el compás donde comienza el ritmo, el último compás", "el nombre del clip, el compás donde comienza el ritmo, el último compás, la cadena de tiempos", "la cadena de tiempos, la pista musical, el compás donde comienza el ritmo, el nombre del clip");
</script>
++++
