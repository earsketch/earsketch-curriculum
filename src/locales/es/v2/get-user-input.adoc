...
* La *declaración de retorno* es una declaración dentro del cuerpo de la función que: A. pide que la función devuelva un valor cuando se llama. B. señala que la función se detenga. Si hay algunas declaraciones después de la palabra clave `return`, se ignorarán.
...
pregunta = "Que tempo te gustaria tener en tu musica? Elije un numero entre 45 y 220."
