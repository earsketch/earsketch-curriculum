...
[source,javascript]
----
// Cómo pedir que el usuario escoja el tempo
...
[source,python]
----
# Cómo crear una canción dubstep con parámetros escogidos por el usuario
...
[source,python]
----
# Imprimir expresiones booleanas
...
[source,python]
----
# Pedir que el usuario escoja un género y crear un ritmo basándose en su elección
...
[source,javascript]
----
// Pedir que el usuario escoja un género y crear un ritmo basándose en su selección
