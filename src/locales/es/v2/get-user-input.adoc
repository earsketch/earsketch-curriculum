...
[source,python]
----
# Vincular dos ritmos usando declaraciones de retorno
...
[source,python]
----
# nombre_de_script: Declaraciones de retorno 2; Devolver el último compás de una función de sección
...
[source,javascript]
----
// Devolver el último compás de una función de sección
...
[source,python]
----
# Cómo usar un booleano para crear variaciones de una función
