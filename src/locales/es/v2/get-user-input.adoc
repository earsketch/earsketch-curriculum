...
* La *declaración de retorno* es una declaración dentro del cuerpo de la función que: 1. B. signals the function to stop. Si hay algunas declaraciones después de la palabra clave `return`, se ignorarán.
