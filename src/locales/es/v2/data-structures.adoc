...
[role="curriculum-javascript"]
Si tienes listas muy largas de variables de sonido, puedes organizarlas eficientemente usando *listas*. Un *arreglo*, también llamado lista en algunos lenguajes de programación, es una colección de valores, o *elementos*, entre corchetes (`[]`) y separada por comas. Aquí hay un ejemplo:
