...
[source,python]
----
# Cómo hacer repetir una instrucción makeBeat() usando un ciclo for
...
[source,python]
----
# Cómo usar print() para aparecer mensajes en la consola
...
[source,javascript]
----
// Cómo usar println() para hacer aparecer (o "imprimir") mensajes en la consola
...
[source,python]
----
# Repetición musical creada sin ciclos de código
...
[source,python]
----
# Repetición musical creada con ciclos de código
...
[source,javascript]
----
// Cómo crear un ritmo de batería que se alterna
