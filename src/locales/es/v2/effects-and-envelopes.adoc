...
Aquí hay un ejemplo de un <em>fade in</em>:
...
[question]
--
¿Cómo asignarías un tiempo de retardo (<em>delay</em>) de 50 milisegundos a un efecto de retardo en la pista musical 3?
