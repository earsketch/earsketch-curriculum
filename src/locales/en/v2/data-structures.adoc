...
* The amount of memory `myList` uses
--

[role="curriculum-python"]
[question]
--
What is the syntax to concatenate two lists `listA` and `listB`, i.e. put the elements of `listB` at the end of `listA`?
[answers]
* `listA + listB`
* `listA ++ listB`
* `listA and listB`
...
[question]
--
How can you get a list from oldList without the first element?
[answers]
* `oldList[1:]`
* `oldList[2:]`
* `oldList[1:-1]`
...
* The amount of memory `myArray` uses
--

[role="curriculum-javascript"]
[question]
--
What is the syntax to concatenate two arrays `arrayA` and `arrayB`, i.e. put the elements in `arrayB` at the end of `arrayA`?
[answers]
...
[question]
--
How can you get an array from `oldArray` without the first element?
[answers]
* `oldArray.slice(1)`
* `oldArray.slice(1, -1)`
* `oldArray.slice(2, -1)`
