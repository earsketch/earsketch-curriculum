...
[question]
--
How can you get all elements from `myList` except the first element?
[answers]
* `myList[1:]`
* `myList[2:]`
* `myList[1:-1]`
...
* The largest element of `myArray`
--
...
[question]
--
How can you all elements from `myArray` except the first element?
[answers]
* `myArray.slice(1)`
* `myArray.slice(1, -1)`
* `myArray.slice(2, -1)`
