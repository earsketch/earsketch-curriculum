...
[answers]
* Turning `12` into `"12"`
* Storing text from a prompt in a variable
* Using `readInput()` to ask for a genre
...
[question]
--
What is final value of this statement?
[source,noicon]
----
not (True and (4 > 5))
----
...
[question]
--
For strings `a` and `b`, which of the following is an example of concatenation?
[answers]
* `a + b`
* `a.b`
* `(a, b)`
