...
[source,python]
----
# Returning the end measure of a section function
...
[source,python]
----
# Using a boolean to create variation in a function
...
[source,python]
----
# Asking user for genre and creating beat accordingly
