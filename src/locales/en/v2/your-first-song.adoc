...
* See the https://earsketch.gatech.edu/landing/#/license[EarSketch License Agreement^] for more details regarding legal use of stock sounds.

One option for artists to share their work is a *Creative Commons* license, which gives permission for others to use their work. In EarSketch, you have access to these samples, and all the music you create in EarSketch is shareable, although you cannot sell it. You can, however, share your music or let other students remix your code, helping to put new art into the world.
