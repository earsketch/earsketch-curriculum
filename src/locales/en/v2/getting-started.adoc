...
To add a sound with `fitMedia()`, use the following form.
...
This code will place the sound `Y18_DRUM_SAMPLES_2` on track 2 from measures 1 to 5.
...
The *sound browser* provides over four thousand sounds to use in your music.
...
* Sounds are covered by a creative commons license. Learn more in the <</en/v2/your-first-song#copyright,copyright chapter>>.
...
OPTIONAL
////
Below is an example scripts using `fitMedia()`. Remember, you can import and edit by clicking the blue clipboard icon.
