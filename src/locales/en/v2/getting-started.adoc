...
[role="curriculum-python"]
_You are in Python mode. Python is one of the most popular programming languages in the world. It is often used for data science, machine learning, and experimentation._

[role="curriculum-javascript"]
_You are in JavaScript mode. JavaScript is one of the most popular programming languages in the world. Almost every website uses JavaScript._
...
For each exercise, you can have your neighbor listen to your song.
...
* `fitMedia()` is the primary way of adding sound to the DAW. It has four parameters, the information it needs to make music:
...
[question]
--
Which of the following is NOT a parameter of `fitMedia()`?
[answers]
* Tempo
* Sound constant
* Track number
...
[question]
--
When debugging your code, error messages will print to:
[answers]
* The console
* The sound browser
* The script browser
