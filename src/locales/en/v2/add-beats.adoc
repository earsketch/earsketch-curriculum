...
* Each beat can be divided into *subbeats*. For example, a 1/4 note can be divided into 2 *eighth (1/8) notes*. When you are counting 1/4 notes, you say "1, 2, 3, 4..." When counting 1/8 notes, you can use "ands": "1 and 2 and 3 and 4 and..." An 1/8 note can also be divided in 2 *sixteenth (1/16) notes*.
* 1 measure is 4 1/4 notes, or 8 1/8 notes, or 16 1/16 notes. Note that the sum of all notes in one measure must be equal to 1. They can be mixed and matched like 1/4 + 1/4 + (1/8 + 1/8) + (1/16 + 1/16 + 1/16 + 1/16) = 1.
...
When you hear your music, if you don't like your first version, it's perfectly fine: tweak your beat to make it sound better and better, until you like what you have.
****
...
<script>
question1 = new Question(1, "Which of these options is a string?", '“Five”', "5", "FIVE", "Five");
question2 = new Question(2, "What does \"0\" represent in a beat pattern string?", "Start playing the clip", "Rest", "Extend the clip", "End the clip");
question3 = new Question(3,"In EarSketch, one measure is...","4 beats long", "4 sub-beats long", "16 beats long", "1 quarter note");
question4 = new Question(4, "One sixteenth note is...", "a quarter of a quarter note", "half a beat", "a quarter of a measure","1 measure");
question5 = new Question(5, "To use the makeBeat() function, what parameters do you need?","clip name, track, start measure, beat string","tempo, track, start measure, end measure","clip name, start measure, end measure, beat string","beat string, track, start measure, clip name");
</script>
++++
