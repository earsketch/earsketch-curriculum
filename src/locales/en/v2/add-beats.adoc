...
* An 1/8 note can also be divided into 2 *sixteenth (1/16) notes*. When counting 1/8 notes, you can use "e" and "a" on each side of the "and": "1 e and a 2 e and a 3 e and a 4 e and a"
