...
[question]
--
Which of the following is NOT an example of a musical transition?
[answers]
* Repeating the same melody for 16 measures
* Adding a riser at the end of a prechorus
* Removing a track to create a pause
* Crossfading between two different tracks
--
