...
What is mixing?
[answers]
* Adjusting the volume of every track
* Adjusting the pitch of every track
* Choosing the instruments
* Choosing the rhythms of your drum beats
--

[question]
--
Which is NOT a conditional statement
[answers]
* This banana is delicious.
* I will do the work if you pay me first.
* I want apples if there are no oranges.
* If it is gold then you should buy it.
--
