...
* Sometimes you will see a number looking like this: 1.74630733714e-05. This is called scientific notation: see the e-05 at the end? It means move the decimal to the right 5 places (replacing with 0 if needed). This is equal to 0.0000174630733714. 
...
# Creating a for loop to compare each track's loudness to 0.1
