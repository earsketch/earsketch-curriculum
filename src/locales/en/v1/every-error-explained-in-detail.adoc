...
[source,python]
----
include::code-examples/every-error-explained-in-detail-untitled1.py.txt[]
----
...
[source,python]
----
include::code-examples/every-error-explained-in-detail-untitled1-correction.py.txt[]
----
...
[source,python]
----
include::code-examples/every-error-explained-in-detail-untitled2.py.txt[]
----
...
[source,python]
----
include::code-examples/every-error-explained-in-detail-untitled2-correction.py.txt[]
----
