...
[source,python]
----
# Randomly selecting clips from a list
...
[source,python]
----
# Constructing the amen break with string concatenation
...
[source,python]
----
# Replacing part of the amen break string with a random beat string
