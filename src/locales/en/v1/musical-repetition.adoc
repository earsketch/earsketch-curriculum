...
[source,python]
----
# Transitioning between sections by looping the lead line
...
[source,python]
----
# Transitioning between sections using an anacrusis
...
[source,javascript]
----
// Transition between sections using an anacrusis
