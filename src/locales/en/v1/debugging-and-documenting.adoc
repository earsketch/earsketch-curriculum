...
<script>
question1 = new Question(1, "Which of the following is not a common type of error found in code?", "Random Errors", "Runtime Errors", "Logic Errors", "Syntax Errors");
question2 = new Question(2, "What happens if your program has a Syntax Error?", "The program does not run at all.", "The program runs, but doesn’t do what you expect.", "The program runs, but prints a warning to the console.", "The program runs at first, but eventually crashes.");
</script>
++++
