...
1. Change the starting measure to 3 and the ending measure to 7. The audio clip will still
play for four measures.
1. Continue to edit tracks 2–5. Practice changing both the starting and ending measure.
1. Find #Verse2 in your code (or type this into your code)
1. Add tracks 6–10 by adding `fitMedia()` functions.
1. Choose sounds from your #soundbank or find new clips in the sound library to insert
in your `fitMedia()` function. Remember: if you use new sound clips, assign them a
variable or “nickname” in your sound bank.
1. For tracks 6–10, use between 8–12 as your starting measure and 12–16 as your ending
measure.
1. Click Run and Play to listen to your code. *You now have a 30 second song!*
