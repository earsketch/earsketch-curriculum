...
[role="curriculum-python"]
Wenn du mit dem Anhören der Musik fertig bist, drücke die rechte Pfeiltaste am unteren Rand des Bildschirms, um fortzufahren.
...
[role="curriculum-python"]
Probiere in den Zeilen 7 und 8 verschiedene Werte für die Parameter start und end aus. Führe dann den Code aus und höre zu, wie sich die Musik verändert.
...
[role="curriculum-python"]
Wenn du ein neues Drum fill ausgewählt hast, führe den Code aus und höre dir das Ergebnis an.
...
[role="curriculum-javascript"]
Du kannst Funktionen, die im Beispielcode enthalten waren, bearbeiten oder auskommentieren oder versuchen, deine eigenen neuen Codezeilen zu schreiben. Wenn du ein neues Lied von Grund auf starten möchtest, drücke das `+` Symbol, um ein neues JavaScript-Skript zu erstellen.
