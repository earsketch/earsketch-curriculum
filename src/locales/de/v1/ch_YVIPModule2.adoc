...
[source,python]
----
include::code-examples/ch_YVIPModule2-untitled1.py.txt[]
----
...
1. Use the assignment operator =  to assign your variable a value.  Ex. `drum=ENTREP_BEAT_DRUMBEAT`
1. Complete for each sound clip in your `#SOUNDBANK`
1. <<building-blocks#variables,Click here>> to learn more about variables
...
1. Type `fitMedia()` in your code editor.
1. Choose a sound from your `#SOUNDBANK` and enter the variable name as your first argument.  Place a comma after the variable name.
1. Enter “*1*” as your trackNumber. Place a comma after the track number.
1. Enter “*1*” as your startMeasure.  Place a comma after the startMeasure
1. Enter “*5*” as your endMeasure. Close your parentheses.
1. Click Run and Play.
1. You have coded your first piece of music. How does it sound?
1. Repeat this process for four more sound clips.  Remember each sound clip needs to be on a different track (2,3,4 etc) and the ending measure must be a larger number than your starting measure.  You can stagger your starting and ending measures as you wish.
1. If you want to add sound clips directly from the sound browser,  you can click the blue clipboard icon to paste it directly in the `fitMedia()` function.
***
