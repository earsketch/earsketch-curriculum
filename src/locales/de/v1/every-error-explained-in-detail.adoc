...
[role="curriculum-javascript"]
*Lösung:* Notiere den Namen jedes Clips in Ihrem Array und benenne jeden mit dem zugehörigen Index, beginnend bei 0. Dies hilft dir, die Struktur des Arrays zu verstehen und was einen Indexfehler verursachen kann.
