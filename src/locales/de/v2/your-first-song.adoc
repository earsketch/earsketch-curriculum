...
. Die Zeile „von earsketch import*“, mit der die EarSketch-Funktionen (wie „fitMedia()“) zum Projekt hinzugefügt werden
...
. Spiele einer Freundin oder einem Freund dein Lied in 3 verschiedenen Tempos vor. Bitte sie oder ihn dann, eine Rangfolge vom langsamsten zum schnellsten Tempo zu erstellen.
****
...
.ÜBUNG
****
. Wähle eine/-n Künstler/-in, den/die du wirklich magst, und finde heraus, welchem Genre er/sie angehört.
...
Um das originale Tempo des Sounds zu finden, fahre mit der Maus über die Soundkonstante Sound-Browser.
