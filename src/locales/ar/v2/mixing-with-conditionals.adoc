...
[source,python]
----
# Using the analyzeTrack() function to print the loudness of a track
...
[source,python]
----
# We analyze the loudness of our tracks
...
[source,python]
----
# If track 1 is louder than track 2, we'll reduce its volume
...
[source,python]
----
# Creating a short song and using conditional statements to mix the tracks
