...
[source,python]
----
include::../../en/code-examples/loops-and-layers-looping-my-beats.py.txt[]
----

[role="curriculum-javascript"]
[source,javascript]
----
include::../../en/code-examples/loops-and-layers-looping-my-beats.js.txt[]
----
...
[source,python]
----
include::../../en/code-examples/loops-and-layers-printing.py.txt[]
----

[role="curriculum-javascript"]
[source,javascript]
----
include::../../en/code-examples/loops-and-layers-printing.js.txt[]
----
...
[source,python]
----
include::../../en/code-examples/loops-and-layers-no-loops.py.txt[]
----

[role="curriculum-javascript"]
[source,javascript]
----
include::../../en/code-examples/loops-and-layers-no-loops.js.txt[]
----
...
[source,python]
----
include::../../en/code-examples/loops-and-layers-loops.py.txt[]
----

[role="curriculum-javascript"]
[source,javascript]
----
include::../../en/code-examples/loops-and-layers-loops.js.txt[]
----
...
[source,python]
----
include::../../en/code-examples/loops-and-layers-incrementing.py.txt[]
----

[role="curriculum-javascript"]
[source,javascript]
----
include::../../en/code-examples/loops-and-layers-incrementing.js.txt[]
----
