...
[role="curriculum-python"]
* 1. الكلمة `in` تفحص اذا كانت قيمة عداد الحلقة في المجال المحدد.
...
[role="curriculum-javascript"]
* ` قياس ++ ` ، أو ` قياس + = 1 ` زيادات قياس بمقدار 1. الكلمة `in` تفحص اذا كانت قيمة عداد الحلقة في المجال المحدد.
