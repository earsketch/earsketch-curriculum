...
. يجب عليك أولا * تعيينه *. نستخدم الرمز "=" والذي يسمى عامل التثبيت*assignment operator*. تعني كتابة `synth1 = HIPHOP_SYNTHPLUCKLEAD_005` أنك تنشئ متغيرًا يسمى synth1 وأنك تخزن البيانات HIPHOP_SYNTHPLUCKLEAD_005 في هذا المتغير.
...
. يجب عليك أولا * تعيينه *. نستخدم الرمز "=" والذي يسمى عامل التثبيت*assignment operator*. نستخدم أيضًا الأمر`var` في بداية السطر. الكتابة`var synth1 = HIPHOP_SYNTHPLUCKLEAD_005;`تعني أنك تقوم بإنشاء متغير يسمى synth1 وأنك تقوم بتخزين البيانات HIPHOP_SYNTHPLUCKLEAD_005 في هذا المتغير.
. HIPHOP_SYNTHPLUCKLEAD_005 هي القيمة *value* الخاصة ب ` synth1 `.
