...
[source,python]
----
include::../../en/v1/code-examples/every-error-explained-in-detail-untitled1.py.txt[]
----
...
[source,python]
----
include::../../en/v1/code-examples/every-error-explained-in-detail-untitled2.py.txt[]
----
...
[source,python]
----
include::../../en/v1/code-examples/every-error-explained-in-detail-untitled3.py.txt[]
----
...
[source,python]
----
include::../../en/v1/code-examples/every-error-explained-in-detail-untitled4.py.txt[]
----
