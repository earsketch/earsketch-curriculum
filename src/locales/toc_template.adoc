...
// reference
== <</{{EARSKETCH_LOCALE_CODE}}/v1/every-effect-explained-in-detail#,Effects, Errors, and EarSketch Functions>>
...
// optional chapters
== <</{{EARSKETCH_LOCALE_CODE}}/v1/teaching-computers-to-listen#,Optional: To Learn More!>>
...
=== <</{{EARSKETCH_LOCALE_CODE}}/v1/ch_HourOfCode#,Hour of Code>>
== <</{{EARSKETCH_LOCALE_CODE}}/v1/ch_YVIPModule1#,Your Voice is Power>>
...
// old curriculum
== <</{{EARSKETCH_LOCALE_CODE}}/v1/ch_u1_intro#,Archived Curriculum (2015-2020)>>
