...
* Satr (masalan, ovozli klip yoki ba'zi misralar nomi). *Belgi* bu `A`, `a`, `2` yoki `=` kabi raqam, harf yoki ramz. Satr - bu ikki tomonidan qo'shtirnoq bilan o'ralgan belgilar to'plami, masalan, `"Hello World 123!"`.
...
[source,python]
----
include::code-examples/add-beats-instead-of-this.py[]
----

[role="curriculum-javascript"]
[source,javascript]
----
include::code-examples/add-beats-instead-of-this.js[]
----
...
[source,python]
----
include::code-examples/add-beats-variables.py[]
----

[role="curriculum-javascript"]
[source,javascript]
----
include::code-examples/add-beats-variables.js[]
----
...
*Konstanta* o'zgaruvchiga o'xshaydi, chunki u o'zida qiymatlarni saqlaydi. Biroq, konstantaning qiymati hech qachon o'zgarmaydi. Misol uchun, EarSketch da `TECHNO_SYNTHPLUCK_001` konstanta bo'lib, u mos keladigan audio faylga ishora qiladi. An'anaga ko'ra, konstanta nomlari katta harflar bilan yoziladi va bo'shliq o'rniga pastki chiziqdan foydalaniladi.
...
* `0` zarbdor ovozli klip ijrosini boshlaydi (masalan, barabanning bir zarbasi).
...
. *Zarba satri*: `"0"`, `"+"` va `"-"` belgilaridan tashkil topgan satr.

Masalan: `makeBeat(DUBSTEP_FILTERCHORD_002, 1, 1, "0--0--000--00-0-")` `0--0--000--00-0-` andozangizni 1-trekka, 1-oʻlchovda, `DUBSTEP_FILTERCHORD_002` ovozli klipidan foydalanib joylashtiradi.
...
[source,python]
----
include::code-examples/add-beats-multi-beat.py[]
----

[role="curriculum-javascript"]
[source,javascript]
----
include::code-examples/add-beats-multi-beat.js[]
----
...
[source,python]
----
include::code-examples/add-beats-examples-of-beats.py[]
----

[role="curriculum-javascript"]
[source,javascript]
----
include::code-examples/add-beats-examples-of-beats.js[]
----
