...
[[volume]]
=== VOLUME (ovoz xajmi yoki balandligi)
...
`VOLUME` ovozning balandligini o'zgartirishga yordam beradi.

|===
|Parametr |Izoh |Standart Qiymat |minQiymat |maksQiymat

|GAIN |Asl tovushning chiqishdagi ovoz balandligi darajasini belgilaydi. |0.0 |-60.0 |12.0
...
`WAH` tovushni kimdir "vah vah" deb kuylashga o'xshash ovozni yaratadi. Bu `WAH_POSITION` parametrini setEffect() funktsiyasini ishlatib o'zgartirganda sodir boladi. Bu resonant bandpass filtri, ya'ni u baland va past chastotalarni ovozini pasaytiradi va o'rta chastotalar oralig'ini kuchaytiradi.
