...
[role="curriculum-python"]
7-satr `fitMedia()` degan funktsiya qo'llanildi. A function is a piece of code that performs an operation. The `fitMedia()` function adds a sound clip to the time line.
