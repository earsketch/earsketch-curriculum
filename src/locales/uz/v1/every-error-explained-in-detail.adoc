...
[role="curriculum-javascript"]
`makeBeat()` ning toʻrtinchi argumenti mos turga ega, lekin u kirishi kerak boʻlgan indeks qiymatlaridan biri yaroqsiz. In this scenario, it is likely that the programmer forgot that array indices start at zero.
