...
[role="curriculum-javascript"]
*Misol:* Quyida `bugun` o'zgaruvchisiga tayinlangan satrni chop etish uchun oddiy skript keltirilgan. However, a mistake within the `println()` function prevents the script from running.
