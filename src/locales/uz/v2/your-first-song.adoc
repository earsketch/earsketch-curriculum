...
. *Freesound* ochiq manbali audio ma'lumotlar bazasi bo'lgan http://freesound.org[freesound.org^] dan tovushlarni bevosita import qilish imkonini beradi. Qidiruv satrida sizga kerak bo'lgan ovozni qidiring. Then select the toggle button in front of the file name to select.
