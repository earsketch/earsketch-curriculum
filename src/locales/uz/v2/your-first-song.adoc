...
Siz jarayonni boshlaganingizda, kompyuter kodi avval kompyuterning *xotirasida* saqlanadi chunki u yeardan kod tezroq chaqiriladi. The *CPU*, or Central Processing Unit, accesses each instruction from the memory and executes it. The CPU is often considered the "brain" of the computer.
