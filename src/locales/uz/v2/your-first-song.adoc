...
. *Freesound* ochiq manbali audio ma'lumotlar bazasi bo'lgan http://freesound.org[freesound.org^] dan tovushlarni bevosita import qilish imkonini beradi. In the search bar, you can look for a type of sound. Then select the toggle button in front of the file name to select.
