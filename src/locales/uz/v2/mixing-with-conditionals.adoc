...
Biz bir nechta shartlarni tekshirishni va har bir shartga qarab turli xil bayonotlar to'plamini bajarishni xohlashimiz mumkin. Siz bir nechta shartlarni ketma ket qo'yishingiz mumkin. Bunda quyidagi sintaksis ishlatiladi:
...
* Jarayoningizni konsolda ko'rsatish uchun `print()` bayonotidan foydalaning. Chop etish bayonotiga misol: `print("trek raqami" + trek + "0,01 dan kattami?")`, agar hisoblagich `trek` `1` ga teng bo'lsa, bu "1 raqamli trek 0,01 dan kattami?" deb chop etadi. `str()` funktsiyasi raqamni (masalan: 1) satrga (masalan: "1") aylantiradi.
****
