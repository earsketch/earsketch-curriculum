...
* Satr (masalan, ovozli klip yoki ba'zi misralar nomi). *belgi* - bu raqam, harf yoki ramz, masalan, `A`, `a`, `2` yoki `=`. Satr bu qo'shtirnoq bilan ajratilgan belgilar guruhi, masalan, `"Salom Dunyo 123!"`.

Biz ma'lumotlarga nom beramiz, shunda uni chaqirish va o'zgartirish osonroq bo'ladi. 
...
. Kodni ishga tushirganingizda, kompyuter `synth1` ni o'qiyotganda HIPHOP_SYNTHPLUCKLEAD_005 ovozli klip nomidan foydalanishi kerakligini tushunadi. 
...
.AMALIYOT
****
Avvalgi skriptlaringizda ovozli klip nomlarini saqlash uchun o'zgaruvchilardan foydalaning. Yordam olish uchun quyidagi misollarni ko'rib chiqing. O'zgaruvchilaringiz ovozli klipingizni tavsiflovchi qisqa va tushunarli nomlarga ega ekanligiga ishonch hosil qiling (masalan, "bas", "tovush_1", ...).
****
...
Biz o'zgaruvchilarning yangi turini yaratamiz: zarbdor andozalarimiz uchun *baraban satrlari*.
...
.AMALIYOT
****
`beatString1` oʻzgaruvchili, `"0"`, `"+"` va `"-"` belgilaridan iborat 16 ta belgli yangi satr yarating.
...
Endi siz `makeBeat()` va zarba satrlari bilan ishlashni boshladingiz. Keling, siz foydalanishingiz mumkin bo'lgan bir nechta asosiy zarba andozalarini o'rganamiz.
